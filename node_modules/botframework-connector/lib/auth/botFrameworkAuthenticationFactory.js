...
class BotFrameworkAuthenticationFactory {
    static create(maybeChannelService, maybeValidateAuthority, maybeToChannelFromBotLoginUrl, maybeToChannelFromBotOAuthScope, maybeToBotFromChannelTokenIssuer, maybeOAuthUrl, maybeToBotFromChannelOpenIdMetadataUrl, maybeToBotFromEmulatorOpenIdMetadataUrl, maybeCallerId, maybeCredentialFactory, maybeAuthConfiguration, maybeBotFrameworkClientFetch, maybeConnectorClientOptions = {}) {
        if (!botbuilder_stdlib_1.tests.isStringNullOrEmpty(maybeToChannelFromBotLoginUrl) ||
            !botbuilder_stdlib_1.tests.isStringNullOrEmpty(maybeToChannelFromBotOAuthScope) ||
            !botbuilder_stdlib_1.tests.isStringNullOrEmpty(maybeToBotFromChannelTokenIssuer) ||
            !botbuilder_stdlib_1.tests.isStringNullOrEmpty(maybeOAuthUrl) ||
            !botbuilder_stdlib_1.tests.isStringNullOrEmpty(maybeToBotFromChannelOpenIdMetadataUrl) ||
            !botbuilder_stdlib_1.tests.isStringNullOrEmpty(maybeToBotFromEmulatorOpenIdMetadataUrl) ||
            !botbuilder_stdlib_1.tests.isStringNullOrEmpty(maybeCallerId)) {
            ...
            if (botbuilder_stdlib_1.tests.isStringNullOrEmpty(maybeChannelService)) {
