...
class BotFrameworkClientImpl {
    ...
    postActivity(fromBotId, toBotId, toUrl, serviceUrl, conversationId, activity) {
        return __awaiter(this, void 0, void 0, function* () {
            botbuilder_stdlib_1.assert.maybeString(fromBotId, ['fromBotId']);
            botbuilder_stdlib_1.assert.maybeString(toBotId, ['toBotId']);
            botbuilder_stdlib_1.assert.string(toUrl, ['toUrl']);
            botbuilder_stdlib_1.assert.string(serviceUrl, ['serviceUrl']);
            botbuilder_stdlib_1.assert.string(conversationId, ['conversationId']);
            botbuilder_stdlib_1.assert.object(activity, ['activity']);
