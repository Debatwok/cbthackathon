...
(function (SkillValidation) {
    ...
    function authenticateChannelToken(authHeader, credentials, channelService, channelId, authConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tokenExtractor = new jwtTokenExtractor_1.JwtTokenExtractor(tokenValidationParameters_1.ToBotFromBotOrEmulatorTokenValidationParameters, openIdMetadataUrl, authenticationConstants_1.AuthenticationConstants.AllowedSigningAlgorithms);
