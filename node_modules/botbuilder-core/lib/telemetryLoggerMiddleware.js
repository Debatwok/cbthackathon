        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (activity) {
                ...
                if (this.logPersonalInformation) {
                    const fromName = (_o = (_m = activity.from) === null || _m === void 0 ? void 0 : _m.name) === null || _o === void 0 ? void 0 : _o.trim();
                    if (fromName) {
                        properties[telemetryConstants_1.TelemetryConstants.fromNameProperty] = fromName;
                    }
                    const activityText = (_p = activity.text) === null || _p === void 0 ? void 0 : _p.trim();
                    if (activityText) {
                        properties[telemetryConstants_1.TelemetryConstants.textProperty] = activityText;
                    }
                    const activitySpeak = (_q = activity.speak) === null || _q === void 0 ? void 0 : _q.trim();
                    if (activitySpeak) {
    ...
    fillSendEventProperties(activity, telemetryProperties) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (activity) {
                ...
                // Use the LogPersonalInformation flag to toggle logging PII data, text and user name are common examples
                if (this.logPersonalInformation) {
                    const recipientName = (_k = (_j = activity.recipient) === null || _j === void 0 ? void 0 : _j.name) === null || _k === void 0 ? void 0 : _k.trim();
                    if (recipientName) {
                        properties[telemetryConstants_1.TelemetryConstants.recipientNameProperty] = recipientName;
                    }
                    const activityText = (_l = activity.text) === null || _l === void 0 ? void 0 : _l.trim();
                    if (activityText) {
                        properties[telemetryConstants_1.TelemetryConstants.textProperty] = activityText;
                    }
                    const activitySpeak = (_m = activity.speak) === null || _m === void 0 ? void 0 : _m.trim();
                    if (activitySpeak) {
                        properties[telemetryConstants_1.TelemetryConstants.speakProperty] = activitySpeak;
                    }
                    if ((_o = activity.attachments) === null || _o === void 0 ? void 0 : _o.length) {
    ...
    fillUpdateEventProperties(activity, telemetryProperties) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (activity) {
                ...
                if (this.logPersonalInformation) {
                    const activityText = (_h = activity.text) === null || _h === void 0 ? void 0 : _h.trim();
                    if (activityText) {
                        properties[telemetryConstants_1.TelemetryConstants.textProperty] = activityText;
                    }
                }
