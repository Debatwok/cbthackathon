...
declare const TypedOptions: z.ZodObject<{
     ...
     */
    messagingEndpointPath: z.ZodString;
    /**
     * Path that the server will listen to for skills requests
     */
    skillsEndpointPrefix: z.ZodString;
    /**
 ...
 */
export declare function makeApp(services: ServiceCollection, configuration: Configuration, applicationRoot: string, options?: Partial<Options>, app?: Application): Promise<[
    Application,
