...
const assertExchangeToken = (val, path) => {
    botbuilder_stdlib_1.assert.unsafe.castObjectAs(val, path);
    botbuilder_stdlib_1.assert.func(val.exchangeToken, path.concat('exchangeToken'));
};
/**
