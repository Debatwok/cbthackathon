...
class CloudAdapter extends botbuilder_core_1.CloudAdapterBase {
    ...
    process(req, resOrSocket, logicOrHead, maybeLogic) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const activity = activityValidator_1.validateAndFixActivity(ActivityT.parse(req.body));
            if (!activity.type) {
    ...
    connectNamedPipe(pipeName, logic, appId, audience, callerId, retryCount = 7) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Spin it up
            yield botbuilder_stdlib_1.retry(() => server.start(), retryCount);
        });
    }
...
class StreamingRequestHandler extends botframework_streaming_1.RequestHandler {
    ...
    processRequest(request) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let activity;
            try {
                activity = activityValidator_1.validateAndFixActivity(ActivityT.parse(yield stream.readAsJson()));
            }
            catch (err) {
